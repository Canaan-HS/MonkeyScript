...
**リリースバージョン：0.0.49-Beta12**

### **アップデート内容**
1. ウェブサイトの変更に対応
2. ページ変化の監視ロジックを修正
3. TextToLink のマッチングを修正・追加

### **既知の問題**
1. ページ変化の監視方法と読み込み待機方法の修正は現在実験的なものです（環境の違いにより異常が発生する可能性があります）
2. メニュー位置の変更後、デバッグ時には変化が見られますが、実際のアプリケーションでは再読み込みが必要です
