...
**Версия релиза: 0.0.50-Beta**

### **Содержание обновления**
1. Оптимизирована навигация QuickPostToggle
2. Добавлена поддержка множественных Post в QuickPostToggle
3. Добавлена функция CacheFetch для ускорения загрузки одинаковых страниц (очищается при закрытии вкладок)
