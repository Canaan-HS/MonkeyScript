...
|   `CacheFetch`    | Кэширование Fetch данных на той же странице для ускорения последующих идентичных загрузок |      `true`      |
...
**Версия релиза：2025.08.06-Beta**

### **Содержание обновления**
1. Оптимизация механизма CacheFetch
  - Уменьшено количество ненужного кэширования запросов, реализовано асинхронное кэширование для снижения задержек и повышения общей производительности.

2. Расширение функций FixArtist
  - Поддержка исправления большего числа тегов
  - Поддержка исправления имён артистов на страницах candfans
  - Изменены переходы по тегам внутри поста: теперь (экспериментально) перенаправляют на сам пост. В неподдерживаемых случаях сохраняется старое поведение
