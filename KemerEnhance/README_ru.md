...
**Релиз: 2025.09.25-Beta**

### **Изменения**
1. Обновлена библиотека инструментов  
2. Улучшен способ сопоставления контента (экспериментально, сообщайте о проблемах)  
3. Удалена функция BackToTop (уже реализована на сайте)  
4. В FixArtist добавлена функция «Быстрый просмотр»
