...
**릴리스 버전：2025.08.06-Beta**

### **업데이트 내용**
1. CacheFetch 기능 최적화
  - 불필요한 요청 캐시를 줄이고 비동기 캐시로 전환하여 실행 지연을 감소시키고 전체 성능을 향상시켰습니다.

2. FixArtist 기능 확장
  - 더 많은 태그 수정 지원
  - candfans 페이지의 아티스트 이름 수정 지원
  - 게시물 내 태그 이동 링크를 해당 게시물 자체로 이동하도록 조정 (실험적). 미지원 항목은 기존 방식 유지
